...
class Tree {
    ...
    public static boolean checkSumProperty(Node root) {
        ...
        boolean currentNodeProperty = (root.data == leftSum + rightSum);

        // Recur for left and right subtrees, and return true only if both subtrees satisfy the sum property
        return currentNodeProperty && checkSumProperty(root.left) && checkSumProperty(root.right);
    }
}
